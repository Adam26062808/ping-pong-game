...
while game_over == False:
    ...
    if paused == False:
        ...
        if ball.rect.x <= 0:
            p2_win_text = default_font.render("P2 won this round gg", True, (66, 242, 245))
        ...
        if ball.rect.right >= width:
            p1_win_text = default_font.render("P1 won this round gg", True, (66, 242, 245))
            window.blit(p1_win_text, (50, 200))
            p1_score += 1
            paused = True
            paused_start = t.time()

        p1_score_text = default_font.render(str(p1_score), True, (66, 242, 245))
        dash_text = default_font.render(" - ", True, (66, 242, 245))
        p2_score_text = default_font.render(str(p2_score), True, (66, 242, 245))
